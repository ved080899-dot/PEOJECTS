...
import { ChevronLeft, CreditCard, Landmark, MapPin, Truck, Wallet } from 'lucide-react';
...
const paymentOptions = [
  ...
  },
  {
    ...
    icon: Truck,
    feeLabel: 'Convenience fee Rs 49',
    nudge: 'Save Rs 49 - Pay Online',
  },
];
        ...
        <main className="flex-1 space-y-4 px-4 py-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {option.feeLabel && <span className="rounded-full bg-red-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.08em] text-red-600 ring-1 ring-red-200">{option.feeLabel}</span>}
                        </div>
                        {option.nudge && <p className="mt-2 text-xs font-medium text-green-600">{option.nudge}</p>}
                      </div>
          ...
          <section className="rounded-3xl border border-gray-200 bg-white p-4 shadow-sm shadow-gray-100/80">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              {codFee > 0 && <div className="flex items-center justify-between"><span>COD convenience fee</span><span className="font-medium text-red-600">Rs {codFee}</span></div>}
